...
namespace CodingSeb.Converters
{
    ...
    {
        public ExpressionEvalMultiBindingConverter()
        { }

        public ExpressionEvalMultiBindingConverter(string expression)
        {
            Expression = expression;
        }

        public ExpressionEvalMultiBindingConverter(string expression, bool optionCaseSensitiveEvaluationActive)
        {
            Expression = expression;
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            try
            {
                ...
                {
                    return evaluator.Evaluate(values[EvaluateBindingAtIndexAsAnExpression].ToString().EscapeForXaml());
                }
                else
                {
                    return evaluator.Evaluate(Expression.EscapeForXaml());
                }
            }
        ...
        public object[] ConvertBack(object value, Type[] targetTypes, object parameter, CultureInfo culture)
        {
            ...
            try
            {
                ...
                return (object[])evaluator.Evaluate(ExpressionForConvertBack.EscapeForXaml());
            }
            catch (Exception ex) when (!ThrowExceptions)
            {
